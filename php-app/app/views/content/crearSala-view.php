...
function isRoomCodeUnique($modelo, $roomCode) {
    ...
    $stmt = $modelo->getDb()->prepare($query); 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($roomName)) {
        ...
        if (!$documento) {
            ...
            } while (!isRoomCodeUnique($modelo, $roomCode));

            $datos = [
                ['campo_nombre' => 'nombreSala', 'campo_marcador' => ':nombreSala', 'campo_valor' => $roomName],
                ['campo_nombre' => 'codigoSala', 'campo_marcador' => ':codigoSala', 'campo_valor' => $roomCode],
                ['campo_nombre' => 'aforoFinalSala', 'campo_marcador' => ':aforoFinalSala', 'campo_valor' => $aforoFinalSala],
                ['campo_nombre' => 'documento', 'campo_marcador' => ':documento', 'campo_valor' => $documento]
            ];

            try {
                $modelo->guardarDatos('sala', datos: $datos);
