...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2024 a las 00:08:23
...
INSERT INTO `clientes` (`idCliente`, `nickname`, `aceptarCookies`, `fechaRegistro`) VALUES
(2, '', 1, '2024-09-10'),
(3, '', 0, '2024-09-10'),
(4, '', 1, '2024-09-10'),
(5, '', 1, '2024-09-10'),
...
(7, '', 1, '2024-09-10'),
(8, 'juan', 1, '2024-09-10'),
(9, 'julan', 1, '2024-09-10'),
(10, 'juan', 1, '2024-09-10'),
(11, 'ggg', 1, '2024-09-10'),
(12, '', 1, '2024-09-10');
...
INSERT INTO `empresa` (`nit`, `nombre`, `direccion`, `ciudad`) VALUES
('1234567', 'juans', 'caller330', 'bogota'),
('12345678', 'jordysas', 'invasión', 'neiva');
...
INSERT INTO `usuarioempresa` (`documento`, `nombres`, `apellidos`, `correo`, `usuario`, `contrasena`, `imgDocumentoLegal`, `fechaRegistro`, `membresia`, `nit`) VALUES
('1057744', 'Julian', 'hoyos', 'hoyos1477@gmail.com', 'julian123', 'julian1234', NULL, '0000-00-00', NULL, NULL),
('12344567889', 'jordy santiago', 'vargas murillo', 'jordy@gmail.com', 'jordy123', 'Jordy1234', NULL, '0000-00-00', NULL, '12345678'),
('123457', 'juan pablo', 'rodriguez palco', 'juan@hotmail.com', 'juanpa1234', 'Juan123456', NULL, '0000-00-00', NULL, '1234567');
